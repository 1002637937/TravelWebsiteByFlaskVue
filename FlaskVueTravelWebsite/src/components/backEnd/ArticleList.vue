<template lang="html">
  <el-row>
    <el-row  style="padding:10px 15px;background:#fff">
      <el-col :span="24">
        <el-button size="small" type="primary" @click="createArticle">创建游记</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span='24' >
          <el-table
             style='width:100%' align="center" :data="articleLists"  v-loading="listLoading" element-loading-text="拼命加载中">
              ...
              <el-table-column   prop="id" min-width="200" label="id" ></el-table-column>
              <el-table-column  prop="classify" min-width="150" label="所属景区" ></el-table-column>
              <el-table-column  prop="title" min-width="180" label="游记标题" ></el-table-column>
